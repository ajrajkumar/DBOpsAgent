...
# Version: 2.0 - Uses PostgreSQL environment variables
# Usage example: ./postgres_healthcheck.sh [--database <DB_NAME>] [--top-tables] [--duplicate-indexes] [--unused-indexes] [--bloat-analysis] [--log-prefix <PREFIX>] [--no-log] [--help]

# Function to display usage information
usage() {
  echo "Usage: $0 [--database <DB_NAME>] [--top-tables] [--duplicate-indexes] [--unused-indexes] [--bloat-analysis] [--log-prefix <PREFIX>] [--no-log] [--help]"
  echo
  ...
  echo "  --log-prefix <PREFIX>  Prefix for the log file (default: postgres_healthcheck)"
  echo "  --no-log               Do not log output"
  echo "  --help                 Display this help message"
  echo
  echo "Example:"
  echo "  $0 --database hr_messy --top-tables --duplicate-indexes"
  echo "  $0 --bloat-analysis --unused-indexes"
  exit 1
}
...
echo "========================================"
echo "Database analyzed: $DB_NAME"
